document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".a-j-navigation-list");
  const headerRef = document.querySelector(".a-j-header");
  const navigationRef = document.querySelector(".a-j-navigation");
  ...
  document.querySelectorAll(".a-j-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".a-j-toggle-button img");
